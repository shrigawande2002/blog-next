            ...
            <div className=' shadow-xl rounded-xl  shadow-slate-950 p-20'>
                ...
                <form action={action} className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col '>
                        ...
                        <input type="text" name='img' placeholder='Enter Image URL' className='p-2 outline-none border border-gray-400 rounded-md shadow-md mt-4' defaultValue={state?.img} />
                    </div>
